...
#include "../../../3rdparty/singleapplication_p.h"
...
void SingleApplicationPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SingleApplicationPrivate *_t = static_cast<SingleApplicationPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SingleApplicationPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SingleApplicationPrivate.data,
      qt_meta_data_SingleApplicationPrivate,  qt_static_metacall, nullptr, nullptr}
};
