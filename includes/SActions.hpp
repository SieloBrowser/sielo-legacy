...
struct SActions {
    ...
    QAction* back{ new QAction(QIcon(themePath + "back.png"), QString("&Précédent")) };
    ...
    QAction* preferences{ new QAction(QIcon(themePath + "preferences.png"), "Pr?&f?rences") };
    QAction* addBookmarks{ new QAction(QIcon(themePath + "addFavoris.png"), "&Nouveau Favoris") };
    QAction* bookmarksManager{ new QAction(QIcon(themePath + "favoris.png"), "&G?r? les favoris") };

    // All other actions
    QAction* newTab{ new QAction(QIcon(themePath + "newTab.png"), "Nouvelle Onglet") };
    QAction* newWindow{ new QAction(QIcon(themePath + "newWindow.png"), "Nouvelle Fen?tre") };
    QAction* openFile{ new QAction("Ouvrir un fichier") };
    QAction* exit{ new QAction(QIcon(themePath + "exit.png"), "Fermer Sielo NAvigateur") };
    QAction* showFullScreen{ new QAction("Afficher en pleine ?cran") };
    ...
    QAction* findPrevious{ new QAction("Trouver le pr?c?dent") };
    ...
    QAction* privateBrowsing{ new QAction("Nouvelle fen?tre navigation priv?e") };
    QAction* downloads{ new QAction("T?l?chargements") };
